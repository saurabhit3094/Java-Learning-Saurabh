...
import com.learning.task.util.CommonUtility;
...
public class Customer implements Serializable {
	...
	public String fetchStatement() {
		...
		while (rentalsItr.hasNext()) {
			...
			thisAmount = rental.fetchRentals();
			
			// add frequent renter points
			frequentRenterPoints++;
			
			// add bonus for a two day new release rental
			frequentRenterPoints = CommonUtility.getFrequentRenterPoint(frequentRenterPoints,rental);
